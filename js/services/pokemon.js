...
(function(){
  ...
  const ALIASES={
    ...
    'deoxys':'deoxys-normal','keldeo':'keldeo-ordinary','meloetta':'meloetta-aria',
  ...
  const EXTRA_FORM_FILES={
    ...
    'terapagos-terastal':'terapagos-terastal','terapagos-stellar':'terapagos-stellar','zacian-crowned':'zacian-crowned','zamazenta-crowned':'zamazenta-crowned'
  };
  ...
  const DISPLAY_CANONICAL={
    ...
    'deoxys-attack':'Deoxys','deoxys-defense':'Deoxys','deoxys-speed':'Deoxys',
